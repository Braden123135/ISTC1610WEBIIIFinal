...
<body>
    <div id="header_div" class="headers">
        <div id="header_logo_div">
            <a href="home.php"> <img id="header_logo_img" class="imgs" src="Rec/Img/Logo/alphaLogo.png"> </a>
        </div>
        ...
        <?php
            if(isset($_SESSION['userId'])){
                ...
                echo '<img id="header_me_img" class="imgs" src="Rec/Img/Me/alphaMe.png">';
